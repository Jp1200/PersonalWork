  ...
  render() {
    return (
      <h1 className="about-h1">
        n:{" "}
        <ButtonGroup size="md">
          <Button variant="outline-light" id="2" onClick={this.changeDegree}>
            2
          </Button>
          <Button variant="outline-light" id="3" onClick={this.changeDegree}>
            3
          </Button>
          <Button variant="outline-light" id="4" onClick={this.changeDegree}>
            4
          </Button>
          <Button variant="outline-light" id="5" onClick={this.changeDegree}>
            5
          </Button>
          <Button variant="outline-light" id="10" onClick={this.changeDegree}>
            10
          </Button>
          <Button variant="outline-light" id="50" onClick={this.changeDegree}>
            50
          </Button>
        </ButtonGroup>
        <P5Wrapper
